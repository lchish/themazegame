/** 
 * Application created by John Dumas for generating a 
 * random x by x maze to stdout that we modified to generate output that 
 * works with our maze game. Code used under permission from author.
 */
#include <cstdio>
#include <cstdlib>
#include <list>
